...
Use the available time-travel tools to calculate the requested dates.
After using a tool, reflect on the result and continue reasoning. 
Give a concise summary of the calculation and the final answer.
...
"""
        ...
        result = await Runner.run(agent, time_travel_problem, max_turns=25)
